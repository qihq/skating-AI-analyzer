...
from app.schemas import ApiConnectionTestResponse, PersonTrackerRuntimeStatusResponse, PoseRuntimeStatusResponse
from app.services.analysis_errors import AnalysisErrorCode, classify_ai_failure
from app.services.person_tracker import get_person_tracker_runtime_status
...
@router.get("/person-tracker-runtime", response_model=PersonTrackerRuntimeStatusResponse)
async def get_person_tracker_runtime() -> PersonTrackerRuntimeStatusResponse:
    return PersonTrackerRuntimeStatusResponse(**get_person_tracker_runtime_status())
