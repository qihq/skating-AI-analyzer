...
class Analysis(Base):
    ...
    retry_from_stage: Mapped[str | None] = mapped_column(String(32), nullable=True)
    ...
    vision_path_a: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True)
    vision_path_b: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True)
    cross_validation: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True)
    ...
    processing_timings: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True)
    processing_logs: Mapped[list[dict[str, Any]] | None] = mapped_column(JSON, nullable=True)
    target_lock: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True)
